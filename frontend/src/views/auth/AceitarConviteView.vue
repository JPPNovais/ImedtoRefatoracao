...
/**
 * Tela de aceite de convite. Aberta via link do e-mail enviado por
 * `CriarConviteAsync` (LocalJwtAuthService) — formato:
    ...
    try {
        ...
        mensagem.value =
            e?.response?.data?.mensagem
                ?? "Não foi possível aceitar o convite. O link pode ter expirado, já ter sido usado ou o e-mail não confere com o convite."
    }
}
    ...
    <div class="aceitar-page">
        <div class="card">
            ...
            <template v-if="estado === 'form' || estado === 'enviando'">
                ...
                <p>
                    Você foi convidado para um estabelecimento no Imedto. Crie sua senha
                    para entrar e revisar o convite.
                </p>
                ...
                <form @submit.prevent="enviar">
                    ...
                    <button type="submit" class="btn btn-primary" :disabled="!podeEnviar">
                        {{ estado === "enviando" ? "Criando conta…" : "Aceitar e criar conta" }}
                    </button>
                </form>

                <button type="button" class="btn btn-link" @click="irParaLogin">
