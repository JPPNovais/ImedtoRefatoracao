namespace Imedto.Backend.Contracts.Cirurgias;

/// <summary>
/// Contrato tipado para a ficha anestésica de um procedimento cirúrgico.
/// Serializado como JSONB na coluna <c>ficha_anestesica</c> do banco.
/// </summary>
