...
public class ReativarAssinaturaAdminCommandHandler
{
    ...
    public ReativarAssinaturaAdminCommandHandler(
    ...
    public async Task Handle(ReativarAssinaturaAdminCommand cmd, CancellationToken ct = default)
    {
