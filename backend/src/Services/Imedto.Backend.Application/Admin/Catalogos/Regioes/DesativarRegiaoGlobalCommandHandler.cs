...
public class DesativarRegiaoGlobalCommandHandler
{
    ...
    public async Task Handle(DesativarRegiaoGlobalCommand command, CancellationToken ct = default)
    {
        ...
        await _audit.RegistrarAsync(
            AcoesAuditAdmin.DesativarRegiaoGlobal,
            command.AdminId,
