...
public class ConfirmarAgendamentoCommandHandlerTests
{
    ...
    private ConfirmarAgendamentoCommandHandler _sut;
    ...
    public void SetUp()
    {
        ...
        _sut = new ConfirmarAgendamentoCommandHandler(_agendaRepo.Object);
    }
    ...
    [Test]
    public async Task Handle_AgendadoNoMesmoTenant_TransicionaParaConfirmado()
    {
        ...
        await _sut.Handle(new ConfirmarAgendamentoCommand
        {
    ...
    [Test]
    public void Handle_AgendamentoDeOutroTenant_LancaMensagemGenerica()
    {
        ...
        var ex = Assert.ThrowsAsync<BusinessException>(() => _sut.Handle(new ConfirmarAgendamentoCommand
        {
            AgendamentoId = AgendamentoId,
            EstabelecimentoId = EstabelecimentoId,
        }));
