...
> **Evolução de estratégia (2026-06-15):** o MVP adotado **não** usa parsers/adaptadores determinísticos por origem (estratégia original, §3 abaixo), e sim **mapeamento de schema assistido por IA** — a IA infere o de-para coluna→campo canônico uma vez por arquivo (sobre amostra mascarada), o operador revisa, e a carga roda determinística pelos commands de domínio existentes. Decisões fechadas (D1–D14) em [`../Discoverys/migracao-dados-ia/01_discovery.md`](../Discoverys/migracao-dados-ia/01_discovery.md). Briefing executável: [`planejamentos/2026-06-15_001_central-de-migracao-mapeamento-por-ia.md`](../../planejamentos/2026-06-15_001_central-de-migracao-mapeamento-por-ia.md). O conteúdo abaixo (posicionamento legal, pesquisa de exports, riscos, métricas) **permanece válido** como contexto; a seção §3 "genérico + adaptadores" foi **superada** pelo mapa por IA. Princípios reusados do desenho original: staging multi-tenant, carga só por command, idempotência por chave natural, desfazer por `job_id`, prontuário sem estrutura vira anexo, LGPD do arquivo bruto (30 dias).
>
> **Princípios novos consolidados no MVP por IA:** (D11) o Imedto gera as próprias PKs e **nunca** importa id técnico da origem — dedupe só por dado de negócio do registro; (D13) o de-para aprovado é salvo como **template por origem** e pré-carregado no próximo job da mesma origem (operador ainda revisa); (D12) desfazer reverte **só os registros criados**, não os atualizados; (D14) limite de **50MB** por ZIP.
